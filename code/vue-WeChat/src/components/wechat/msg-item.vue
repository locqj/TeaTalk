<template>
    ...
    <li :class="{'item-hide':deleteMsg}">
        ...
        <router-link tag="div" :to="{ path: '/wechat/dialogue1', query: { name:item.nickname }}" class="list-info" v-swiper v-on:click.native="toggleMsgRead($event,'enter')">
            ...
            <div class="desc-box">
                <!--使用过滤器 fmtDate 格式化时间-->
                <div class="desc-time">20:15</div>
                <!--如果没有备注好友，则显示微信昵称-->
                <div class="desc-author" >{{item.nickname}}</div>
                <!-- <div class="desc-msg">
